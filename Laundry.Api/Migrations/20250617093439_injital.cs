    ...
    public partial class injital : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 6, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 6, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, null, 1 },
                    { 2, new DateTime(2025, 6, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("55555555-5555-5555-5555-555555555555"), null, new DateTime(2025, 6, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, null, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Great service!", new DateTime(2025, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("44444444-4444-4444-4444-444444444444"), 5, null, null, 1 },
                    { 2, "Good but room for improvement.", new DateTime(2025, 6, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("55555555-5555-5555-5555-555555555555"), 4, null, null, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("44444444-4444-4444-4444-444444444444"), false, "Do you offer express service?", new DateTime(2025, 6, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, new Guid("55555555-5555-5555-5555-555555555555"), false, "Can I schedule a pickup on weekends?", new DateTime(2025, 6, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), 2 }
                });
